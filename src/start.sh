...
# Commentaire : On change ici ou l'on crée le fichier car nous n'avons pas les droits en tant que USER,
# du au fait du validator.sh qui spécifie du read-only. Les fichiers temp quant a eux sont généralement accessibles. 
...
# Commentaire : On change ici ou l'on écrit dans le fichier car nous n'avons pas les droits en tant que USER,
# du au fait du validator.sh qui spécifie du read-only. Les fichiers temp quant a eux sont généralement accessibles. 
